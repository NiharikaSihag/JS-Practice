...
let a = 2.49403;
console.log(Math.ceil(a)); // rounded off to larger nbumber
console.log(Math.round(a)); // normal converison last pointer is above 5 then +1 else round off
console.log(Math.floor(a)); // round off to lower number
console.log(Math.sign(a)); // 1 for positive number, -1 for negative, 0 for 0
